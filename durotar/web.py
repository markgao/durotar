...
from durotar.util import import_module
...
class RequestHandler(tornado.web.RequestHandler):
    ...
    def render_string(self, template_name, **kwargs):
        ...
        context = dict()
        try:
            context.update(self.write_context())
        except Exception:
            app_log.error("Uncaught exception in write_context", exe_info=True)
    ...
    def write_context(self):
        """Override to implement custom context. Must return as a dict.
        """
        return dict()
